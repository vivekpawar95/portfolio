          ...
          {hideContent ? null : (
            <>
              ...
              <p style={{ fontSize: "14px", marginBottom: "30px" }}>
                ...
                <a href="https://github.com/vivekpawar95/portfolio/issues/new">
                  @vivekpawar95
                </a>
              </p>
              {!isVerified ? (
                ...
                <span
                  dangerouslySetInnerHTML={{
                    __html: WelMsg.replace(
                      "Github",
                      '<a href="https://github.com/vivekpawar95" target="_blank" rel="noopener noreferrer" style="color: #3498db;">Github</a>'
                    ),
                  }}
                />
              </h2>
        ...
        {autoupdatecheck && (
          ...
          >
            <p>
              ...
              {versionDetails ? (
                <a
                  href={`https://github.com/vivekpawar95/portfolio/releases/tag/v${versionDetails.currentVersion}`}
                  target="_blank"
